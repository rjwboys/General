...
public class setspawnCommand extends CommandBase {
    ...
    public boolean fromPlayer(General plugin, Player sender, Command command, String commandLabel,
        ...
        case 2: // /setspawn <player> <destination>
            ...
            if(Toolbox.equalsOne(args[0], "self", "$self", "me")) {
                if(Toolbox.lacksPermission(plugin, sender, "see the spawn location", "general.spawn.home")) return true;
                who = sender;
            } else {
                if(Toolbox.lacksPermission(plugin, sender, "see the spawn location", "general.spawn.home.other")) return true;
    ...
    private void setSpawn(CommandSender sender, Destination dest, World from) {
        ...
        if(dest.hasPermission(sender, "set the spawn location", "general.spawn.set")) {
            ...
            feedback = fmt.format(feedback, world.getName(), loc.getBlockX(), loc.getBlockY(), loc.getBlockZ()).toString();
            Messaging.send(sender, feedback);
        }
    }
}
