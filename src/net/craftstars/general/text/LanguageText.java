...
public enum LanguageText {
	...
	MISC_STOPPING("misc.stopping.generic", "Server shutting down"),
	MISC_STOPPING_BECAUSE("misc.stopping.because", "Server shutting down ({reason})"),
	MISC_STOPPING_SOON("misc.stopping.soon", "{player} is shutting down the server in {when}..."),
